...
public:
    NEURON(int myID, int neuronType, double tau, double a, double lastValue, double value);
...
private:
	...
	void Initialize(int myID, int neuronType, double t, double a, double lastValue, double value);
